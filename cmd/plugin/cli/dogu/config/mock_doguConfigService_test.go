...
// Edit provides a mock function with given fields: registryKey, registryValue
func (_m *mockDoguConfigService) Edit(registryKey string, registryValue string) error {
...
func (_e *mockDoguConfigService_Expecter) Edit(registryKey interface{}, registryValue interface{}) *mockDoguConfigService_Edit_Call {
	return &mockDoguConfigService_Edit_Call{Call: _e.mock.On("Edit", registryKey, registryValue)}
}

func (_c *mockDoguConfigService_Edit_Call) Run(run func(registryKey string, registryValue string)) *mockDoguConfigService_Edit_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *mockDoguConfigService_Edit_Call) RunAndReturn(run func(string, string) error) *mockDoguConfigService_Edit_Call {
	_c.Call.Return(run)
	return _c
}

// EditAllInteractive provides a mock function with given fields:
func (_m *mockDoguConfigService) EditAllInteractive() error {
	ret := _m.Called()
...
// mockDoguConfigService_EditAllInteractive_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'EditAllInteractive'
type mockDoguConfigService_EditAllInteractive_Call struct {
	*mock.Call
}

// EditAllInteractive is a helper method to define mock.On call
func (_e *mockDoguConfigService_Expecter) EditAllInteractive() *mockDoguConfigService_EditAllInteractive_Call {
	return &mockDoguConfigService_EditAllInteractive_Call{Call: _e.mock.On("EditAllInteractive")}
}

func (_c *mockDoguConfigService_EditAllInteractive_Call) Run(run func()) *mockDoguConfigService_EditAllInteractive_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockDoguConfigService_EditAllInteractive_Call) Return(_a0 error) *mockDoguConfigService_EditAllInteractive_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *mockDoguConfigService_EditAllInteractive_Call) RunAndReturn(run func() error) *mockDoguConfigService_EditAllInteractive_Call {
	_c.Call.Return(run)
	return _c
}
